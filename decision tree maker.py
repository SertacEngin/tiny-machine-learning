...
# Decision Tree for Object Prediction Model
clf_object = DecisionTreeClassifier()
clf_object.fit(X_train_scaled, y_object_train)
plt.figure(figsize=(20,10))
plot_tree(clf_object, filled=True, feature_names=['Power Consumption', 'Time'], class_names=["Class 0", "Class 1"])
plt.show()

# Decision Tree for Path Prediction Model
clf_path = DecisionTreeClassifier()
clf_path.fit(X_train_scaled, y_path_train.argmax(axis=1))
plt.figure(figsize=(20,10))
plot_tree(clf_path, filled=True, feature_names=['Power Consumption', 'Time'], class_names=["Class 23", "Class 25", "Class 27", "Class 28"])
plt.show()
